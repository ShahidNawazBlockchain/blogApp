      ...
      <div className='flex justify-center items-center mt-16'>
        <div className='w-96 rounded-2xl bg-slate-900'>
          <div className='flex flex-col gap-2 p-8'>
            ...
            <input className='bg-slate-900 w-full rounded-lg border border-gray-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 focus:ring-offset-gray-800' placeholder='Email' name='email' value={profileData.email} onChange={handleChange} />
